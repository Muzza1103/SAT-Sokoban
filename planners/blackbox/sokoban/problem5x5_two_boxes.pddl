(define (problem sokoban5x5_two_boxes_harder)
  ...
  (:init
    ...
    ;; WALLS (optionnel, pas utilisé par les actions)
    (wall c6)
    (wall c8)
    (wall c17)

    ;; CLEAR = toutes les cases non-wall et sans box
    (clear c1) (clear c2) (clear c3) (clear c4) (clear c5)
    (clear c9) (clear c10)
    (clear c11) (clear c12) (clear c14) (clear c15)
    (clear c16) (clear c18) (clear c19) (clear c20)
    (clear c21) (clear c22) (clear c23) (clear c24) (clear c25)
