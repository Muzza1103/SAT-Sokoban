(define (problem sokoban6x6_three_boxes)
  ...
  (:init
    ...
    (clear c9) (clear c11) (clear c12)
    (clear c13) (clear c15) (clear c16) (clear c18)
    (clear c19) (clear c20) (clear c22) (clear c23) (clear c24)
    (clear c25) (clear c27) (clear c28) (clear c29) (clear c30)
    (clear c31) (clear c32) (clear c33) (clear c34) (clear c35) (clear c36)
